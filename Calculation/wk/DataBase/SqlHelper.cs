...
namespace wk
{
    ...
    public static partial class SqlHelper
    {
        ...
        static SqlHelper()
        {
            //connStr = "server=.;DataBase=winApp;uid=sa;pwd=123456";
            connStr = "Data Source=qds117733100.my3w.com;Initial Catalog=qds117733100_db;User ID=qds117733100;Password=ljx159263";
        }
